...
<body>
	<form action="form_membership2.jsp" name="person_info" method="get">
			...
			<legend> 개인 정보 입력 </legend><p>
			  ...
			  이름 : <br>
				...
				<select name="choice" style="width:60px; height:20.5px">
					<option vlaue="choice"> 선택 </option>
					<option value="KT"> KT </option>
					<option value="SKT"> SKT </option>
					<option value="LG U+"> LG U+ </option>
				</select>
				
				<input type="text" maxlenghth="3" size="3" name="phone1"> -
				<input type="text" maxlenghth="4" size="4" name="phone2"> -
				<input type="text" maxlenghth="4" size="4" name="phone3"><br><br>
